...
##Keys for Certain Attributes in population.csv
******
![](./keys.png)
******
...
##Shiny Source Files
******
**Two plots are displayed at the same time by the shiny app, one is the total population of all states, and the other is the age distribution in the specified state.**
